...
export const PARTY_COPY = {
  ...
  captionLabel: "CAPTION · | FÜR ZWEI ZEILEN",
  captionExample: "Beispiel: OPTION A | OPTION B (mehr Teile mit |)",
  joinHeroTag: "DAS PARTY-SPIEL FÜR SCHLECHTE TAKES",
  joinHeroTitle1: "Schlechteste",
  joinHeroTitle2: "gewinnt",
  joinHeroBody: (min: number) =>
    `Alle bekommen dasselbe Meme. Ihr schreibt Captions. Die Gruppe votet. Lustigste Punkte. ${min}–8 Spieler. Kostenlos.`,
...
export const PARTY_TUTORIAL_SLIDES = [
  ...
  },
  {
    ...
    body: "60 Sekunden. Meme-Template erscheint, du schreibst deinen Text. Lustig schlägt clever.",
  },
  {
    num: "03",
    color: "#00E1FF",
